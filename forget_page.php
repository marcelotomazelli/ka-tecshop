			...
			<div id="forms">
				...
				<? if(!$verified_email && $verified_code === false) { ?>
					<div id="form-verify-email">
						...
						<form name="formverifyemail" action="./php/forget_control.php?t=email" method="post">
				...
				<? if($verified_email && $verified_code === false) { ?>
					<div id="form-verify-code">
						...
						<form name="formverifycode" action="./php/forget_control.php?t=code" method="post">
				...
				<? if($verified_email && $verified_code) { ?>
					<div id="form-new-pass">
						...
						<form name="formnewpass" action="./php/forget_control.php?t=newpass" method="post">
